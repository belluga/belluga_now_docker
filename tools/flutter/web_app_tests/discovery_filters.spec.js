  ...
  const response = await api.post(
    buildUrl(baseUrl, '/admin/api/v1/account_profile_types'),
    {
      ...
      data: {
        ...
        allowed_taxonomies: allowedTaxonomies,
        capabilities: {
          is_queryable: { value: isQueryable, parameters: {} },
          is_publicly_navigable: {
            value: isPubliclyNavigable,
            parameters: {},
          },
          is_favoritable: { value: isFavoritable, parameters: {} },
          is_publicly_discoverable: {
            value: isPubliclyDiscoverable,
            parameters: {},
          },
          location_policy: { value: locationPolicy, parameters: {} },
          is_map_poi_enabled: { value: isMapPoiEnabled, parameters: {} },
          is_physical_host_enabled: {
            value: isPhysicalHostEnabled,
            parameters: {},
          },
          is_reference_location_enabled: {
            value: isReferenceLocationEnabled,
            parameters: {},
          },
          has_taxonomies: {
